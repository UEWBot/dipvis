...
round_patterns = [
    ...
    path('board_call_by_player/', round_views.round_simple,
         {'template': 'board_call_by_player'}, name='board_call_by_player'),
...
tournament_patterns = [
    ...
    path('enter_player_ranks/', tournament_views.enter_player_ranks,
         name='enter_player_ranks'),
    path('enter_team_ranks/', tournament_views.enter_team_ranks,
         name='enter_team_ranks'),
