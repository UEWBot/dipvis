...
round_patterns = [
    ...
    url(r'^views/$', views.round_simple,
...
game_patterns = [
    ...
    url(r'^news_ticker/$', views.game_news,
...
tournament_patterns = [
    ...
    url(r'^game_results/$', views.tournament_game_results,
    ...
    url(r'^best_countries/$', views.tournament_best_countries,
    ...
    url(r'^background/$', views.tournament_background,
    ...
    url(r'^csv_classification/$', views.view_classification_csv,
