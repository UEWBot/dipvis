...
game_patterns = [
    ...
    url(r'^graph/$', game_views.graph, name='graph'),
    # This is the page showing the graph
    url(r'^sc_graph/$', game_views.game_sc_graph, name='game_sc_graph'),
    url(r'^sc_graph_refresh/$', game_views.game_sc_graph,
    ...
    url(r'^overview3/$', game_views.game_sc_graph,
        {'refresh': True, 'redirect_url_name': 'game_overview_4'},
        name='game_overview_3'),
    url(r'^overview4/$', game_views.game_image,
