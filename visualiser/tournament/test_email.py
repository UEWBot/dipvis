...
from tournament.models import T_SCORING_SYSTEMS, SECRET
...
class EmailTests(TestCase):
    ...
    def setUpTestData(cls):
        ...
        TournamentPlayer.objects.create(player=cls.p8, tournament=t)
        ...
        TournamentPlayer.objects.create(player=cls.p9, tournament=t)
        ...
        TournamentPlayer.objects.create(player=cls.p10, tournament=t)
        ...
        TournamentPlayer.objects.create(player=cls.p11, tournament=t)
        ...
        TournamentPlayer.objects.create(player=cls.p12, tournament=t)
        ...
        TournamentPlayer.objects.create(player=cls.p13, tournament=t)
        ...
        cls.p14 = Player.objects.create(first_name='Arthur',
                                        last_name='Bottom')
        TournamentPlayer.objects.create(player=cls.p14, tournament=t)
        ...
        TournamentPlayer.objects.create(player=cls.p15, tournament=t)
        ...
        cls.p17 = Player.objects.create(first_name='Geraldine',
                                        last_name='Hogwash')
        TournamentPlayer.objects.create(player=cls.p17, tournament=t)
        ...
        cls.p18 = Player.objects.create(first_name='Idiot',
                                        last_name='Jalopy')
        TournamentPlayer.objects.create(player=cls.p18, tournament=t)
        ...
        cls.p19 = Player.objects.create(first_name='Keith',
                                        last_name='Llama')
        TournamentPlayer.objects.create(player=cls.p19, tournament=t)
        ...
        TournamentPlayer.objects.create(player=cls.p20, tournament=t)
        ...
        cls.p21 = Player.objects.create(first_name='Olivia',
                                        last_name='Petticoat')
        TournamentPlayer.objects.create(player=cls.p21, tournament=t)
        ...
        cls.p22 = Player.objects.create(first_name='Quentin',
                                        last_name='Radish')
        TournamentPlayer.objects.create(player=cls.p22, tournament=t)
